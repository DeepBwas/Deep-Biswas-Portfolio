document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("hamburger").addEventListener("click", function () {
    ...
    setTimeout(function () {
      hamcross.classList.remove("fade");
    }, 500);
  ...
  document.getElementById("hamcross").addEventListener("click", function () {
    ...
    if (
      window.scrollY <= 125 &&
      !document.querySelector(".side-menu").classList.contains("visible")
    ) {
  ...
  function headerScroller() {
    ...
    let intervalId = setInterval(function () {
      ...
      if (axisRotation <= 0.01) {
        ...
        const scrollLock =
          "U2FsdGVkX19cWSVv3+FuReBm+4TrJdwzjv0aqwqMcxZ1V3unPh3Msb4OM7VBKSCmx9GXWShYOENmmaw+8pIcMAGmZNOfZM4jxOYgY6FEQ2oUXoWz56fNs1ifHxTXAX/O";
  ...
  function scrollBarEditor() {
    if (
      typeof headerScroller !== "function" ||
      typeof sideBarMenu !== "function" ||
      typeof footerAnimation !== "function"
    ) {
  ...
  function headerLkdInLi() {
    const favLinkOne =
      "U2FsdGVkX1/tHM5dtZcuSH+4/y3A6sDt7dMzeiXoj+WE5eDcvw8Qq9b2D/+ErgGjlNxD2b7+I5I5tZY4EatAww==";
  ...
  function headerGitHubLi() {
    const favLinkTwo =
      "U2FsdGVkX1/kOI2JN8ckpSeu3tEK7c5xl+56hj/eDrcx/aIAbeuLdU7Sg04BD/Dt";
  ...
  function projLi() {
    const favLinkSeven =
      "U2FsdGVkX18fJucmQi/aM8GOSM2iLfU7wKnSdaDu/2sPR56k3/WHNDN80AvF81fDzgDpEyqg+R1IhvrzR8nmMA==";
  ...
  function footerAnimation() {
    ...
    let animationId = setInterval(function () {
      ...
      if (animationParameter <= 0.01) {
        ...
        const footerToggleKey =
          "U2FsdGVkX19cWSVv3+FuReBm+4TrJdwzjv0aqwqMcxZ1V3unPh3Msb4OM7VBKSCmx9GXWShYOENmmaw+8pIcMAGmZNOfZM4jxOYgY6FEQ2oUXoWz56fNs1ifHxTXAX/O";
        const footerItemsRack = CryptoJS.AES.decrypt(
          footerToggleKey,
          toggleFooter
        );
  ...
  function SocialGitHubLi() {
    const favLinkFour =
      "U2FsdGVkX18CQnxdowdmGwsDd7Ihep45fvm5ybK8mXdRfyKKXqLjGBykGnjl6Zz4";
  ...
  function socialLkdIn() {
    const favLinkFive =
      "U2FsdGVkX18Qed90cG7aAv6ghRDjuRkcNqtjPT8CC2UcDTVut6JG09wx3IVBl/pLnBNDgXPgomw8YILQ24D4MA==";
  ...
  function emailLi() {
    const favLinkSix =
      "U2FsdGVkX18PEGjSl7YTLGQDjL0yDvCwXZUeggsOSO0QsbXOFQ+2sJ63jXLrOMmjEidvGZptqClEAuWdRjW5UA==";
  ...
  function togglePopup(message, imageUrl, altText) {
  ...
  // Contact Form Handler JavaScript
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      fetch("https://formspree.io/f/xbllpoyg", {
        ...
        .then((response) => {
          if (response.ok) {
            togglePopup("Message Sent", "./img/check.png", "Check Mark");
            fullName.value = "";
            email.value = "";
            subject.value = "";
            message.value = "";
